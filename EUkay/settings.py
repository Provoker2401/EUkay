"""
Django settings for EUkay project.
...
SECRET_KEY = 'django-insecure-b2dqrcxo8p(4q$y=t9rb5*&+=k%+6^zz6m78iy8o@80ovo6g@@'
...
WSGI_APPLICATION = 'EUkay.wsgi.application'
